...
export type Translations = {
  ...
  transportation: { title: string; airport: { title: string; content: string; options: TransportOption[] }; city: { title: string; content: string; steps: string[] }; selfDrive: { title: string; content: string; steps: string[] }; train?: { title: string; content: string; steps: string[] } };
...
export const translations: Record<Locale, Translations> = {
  zh: {
    ...
    about: {
      ...
      p2: "奥扬泰坦博最令人震撼的，是其正面墙（Frontal Wall）上巨大的多边形巨石。这些来自附近山脉的粉红色流纹岩/斑岩（Pink Rhyolite / Porphyry）巨石，每块重达50吨以上，被精确切割成复杂的多边形，严丝合缝地嵌入墙体。在没有任何金属工具和车轮的印加时代，这些巨石是如何被开采、运输并精确安装的，至今仍是考古学和工程学的未解之谜。",
      highlights: { title: "景点亮点", items: ["巨石神殿: 正面墙六块巨石，每块重50吨以上", "活古城: 至今仍有居民生活的印加古城", "创世神之脸 (Face of Viracocha): 对面 Pinkuylluna 山壁上大自然与古人共雕的巨大神明面庞", "太阳观测台: 祭祀太阳神Inti的神圣场所", "梯田要塞: 印加军事防御工程的典范", "圣谷门户: 通往马丘比丘的必经之地"] },
      bestTime: { title: "最佳参观时间", content: "07:00-17:00\n建议清晨参观，避开人群且光线柔和\n雨季（12月-3月）需注意防滑", tip: "💡 建议: 清晨07:00开园时到达，游客最少且能拍摄无人的巨石神殿" }
    },
    architecture: {
      subtitle: "巨石建筑之谜：50吨斑岩如何飞越山谷？",
      content: "奥扬泰坦博最令人敬畏的，是其正面墙（Frontal Wall）上的六块巨型多边形粉红色流纹岩/斑岩。这些巨石来自距离遗址约6公里外的Cachiccata采石场，位于山谷对面的高山之上。\n\n**超越想象的巨石运输：**\n每块巨石重达50吨以上，印加人必须将这些巨石从高山上开采下来，然后将其滚过Urubamba河，再沿着陡峭的山坡拉上山。由于没有车轮和铁器，他们只能依靠原木滚木、坚韧的龙舌兰纤维绳索，以及数以千计的劳工，才能完成这项看似不可能的任务。\n\n**多边形无缝石工：**\n这些巨石被精确切割成复杂的多边形，完美嵌套在一起。石缝间连一张纸都插不进去。这种无灰泥的建筑技术，不仅展现了印加人卓越的石工技艺，更赋予了建筑极强的抗震能力。\n\n**未完工的太阳神殿与“疲惫之石”：**\n事实上，这面宏伟的巨石墙是一个巨大的历史悬念——它其实是未完工的。当西班牙人入侵时，太阳神殿的修建被迫中断。在从采石场到遗址的沿途，至今仍散落着数十块被称为“疲惫之石”（Tired Stones）的巨石。它们无声地诉说着这座宏伟神殿因战争戛然而止的命运。\n\n💡 **建筑知识：** 奥扬泰坦博的正面墙是印加石工技术的巅峰之作。与萨克塞华曼的粗犷巨石不同，这里的巨石更加精致，展现了印加人在微观和宏观建筑上的双重造诣。"
    },
    culture: {
      subtitle: "印加文化的活化石：至今仍在使用的古城",
      content: "奥扬泰坦博不仅是一处考古遗址，更是一个「活着的」印加古城。这里的许多建筑、街道和灌溉系统，至今仍按照印加时代的规划在使用。\n\n**印加城市规划的典范：**\n奥扬泰坦博的城市布局严格遵循印加人的城市规划理念。街道呈网格状分布，中央有宽阔的广场，周围是皇家庄园和神殿。复杂的灌溉系统将山泉水引入城镇，为居民提供清洁的饮用水。\n\n**公主浴池（Baño de la Ñusta）与水利奇迹：**\n在遗址底部，有一个精美的水利工程被称为“公主浴池”。这不仅是供水系统，其精密切割的导流槽可以让水流在没有任何机械动力的情况下，完美呈现出几何形状的瀑布，是印加流体力学的神作。\n\n**太阳观测台（Intihuatana）：**\n在遗址的最高处，有一块精心雕刻的石头，被称为Intihuatana（太阳观测台）。这是印加人用来观测太阳运行、确定农事节气的神圣工具。每年冬至和夏至，阳光会精确地照射在特定的岩石上，展现了印加人卓越的天文知识。\n\n💡 **文化知识：** 奥扬泰坦博是了解印加文化和历史的绝佳窗口。建议聘请当地导游，深入了解这座古城的秘密。"
    },
    ollantaytambo: {
      title: "历史长河 | 帝国的要塞与抗争",
      subtitle: "历史的见证：西班牙征服者与印加人的最后一战",
      content: "奥扬泰坦博在印加帝国历史上占有重要地位。1536年，印加皇室后裔曼科·印加（Manco Inca）在这里击败了西班牙征服者，取得了印加人对抗西班牙殖民者的唯一一次重大胜利。\n\n**浪漫与反叛的名字由来：**\n“Ollantaytambo”这个名字本身就充满传奇色彩。它得名于印加帝国一位平民出身的英雄将军奥扬泰（Ollantay）。传说他爱上了国王帕查库特克（Pachacuti）的女儿，但因阶级悬殊遭到拒绝。冲冠一怒之下，奥扬泰在此拥兵自立。这个印加版的罗密欧与朱丽叶故事，让这些冰冷的巨石多出了几分人情味。\n\n曼科·印加将奥扬泰坦博作为反抗西班牙的统治中心。他利用这里险要的地形，在山谷中修筑了防御工事，并成功击退了西班牙人的进攻。然而，随着西班牙援军的到来，曼科·印加最终被迫撤退到维尔卡班巴（Vilcabamba）丛林中，奥扬泰坦博也随之落入西班牙人之手。\n\n今天我们看到的奥扬泰坦博遗址，是印加帝国鼎盛时期的建筑杰作。它不仅是军事要塞，更是印加人城市规划、建筑技术和文化信仰的集中体现。\n\n💡 **旅行建议：** 从奥扬泰坦博可以继续前往马丘比丘（乘火车约1.5小时）。建议安排2-3天的圣谷行程，依次参观钦切罗（Chinchero）、莫雷梯田（Moray）、盐田（Maras Salt Pans）和奥扬泰坦博。"
    },
    visiting: {
      title: "游览指南",
      hours: { title: "开放时间", content: "07:00 - 17:00\n全年开放", note: "⚠️ 提醒：建议白天参观，安全和光线更佳。" },
      price: { title: "门票费用", content: "不可单买门票\n需凭库斯科游客通票\n（Boleto Turístico del Cusco）入场\n入口处可买部分通票(Circuit 3)", note: "⚠️ 重要提示：奥扬泰坦博不设独立售票处，必须持有库斯科游客通票（BTC）。", ticketTip: "🎫 官方票务指南：景点不设单一门票。游客需购买库斯科游客通票（Boleto Turístico）。虽然遗址入口处通常可以买到包含此景点的‘部分通票（Circuit 3）’，但为了节省排队时间，强烈建议在库斯科市区的 <a href='https://www.culturacusco.gob.pe/' target='_blank' rel='noopener noreferrer' style='color:inherit;text-decoration:underline;'>[官方网点]</a> 提前买好。" },
    ...
    transportation: {
      ...
      train: { title: "重要：前往马丘比丘的火车门户", content: "奥扬泰坦博是前往马丘比丘最重要的火车枢纽站。从这里出发的火车班次最多，且比从库斯科出发更便宜、用时更短（约1.5小时）。", steps: ["强需求：务必提前在官网预订火车票", "火车站距离遗址入口约15分钟步行路程", "可选择 PeruRail 或 Inca Rail", "建议：白天游览遗址，傍晚乘火车前往热水镇住宿"] }
    },
    tips: { title: "游览建议", items: [
      "⚠️ 高原反应预警：奥扬泰坦博海拔约2792米，比库斯科低约600米，但仍需注意高反。",
      "💡 交通建议：建议从库斯科包车前往，既节省时间又舒适。",
      "🎫 门票提示：必须购买Boleto Turístico通票，不能在门口单独买票。遗址入口可购买包含此景点的“部分通票（Circuit 3）”，但强烈建议在库斯科官方网点提前购买以节省时间。",
    ...
    faq: { title: "常见问题", subtitle: "深入了解奥扬泰坦博", items: [
      ...
      { question: "参观奥扬泰坦博需要门票吗？", answer: "需要。奥扬泰坦博不能在门口单独买票，必须凭库斯科游客通票（Boleto Turístico del Cusco）入场。通票分为以下几种：\n• 全套通票（130索尔，10天有效）：包含所有遗址\n• Circuit 3（70索尔，2天有效）：包含奥扬泰坦博、Pisac、Chinchero、Moray等\n虽然遗址入口处通常可以买到包含此景点的‘部分通票（Circuit 3）’，但为了节省排队时间，强烈建议在库斯科市区的官方网点购买，避免被宰。通票价格可能会变动，以官方公布为准。" },
  ...
  en: {
    ...
    about: {
      ...
      highlights: { title: "Highlights", items: ["Megalithic Temple: Six megalithic stones, each over 50 tons", "Living City: An ancient Inca town still inhabited today", "Face of Viracocha: A massive deity face carved by nature and ancients on the opposite Pinkuylluna cliff", "Intihuatana: Sacred solar observatory", "Terrace Fortress: Model of Inca military defense", "Sacred Valley Gateway: Essential stop to Machu Picchu"] },
    ...
    transportation: {
      title: "Getting There & Gateway to Machu Picchu",
      ...
      train: { title: "Important: Train Gateway to Machu Picchu", content: "Ollantaytambo is the most important train hub to Machu Picchu. Trains from here are the most frequent, cheaper, and shorter (about 1.5 hours) than from Cusco.", steps: ["High demand: Must book train tickets in advance on official websites", "The train station is about 15 mins walk from the ruins entrance", "Choose between PeruRail or Inca Rail", "Tip: Visit the ruins in the day, then take an evening train to Aguas Calientes"] }
    },
    tips: { title: "Travel Tips", items: [
      ...
      "🎫 Ticket Tip: Must purchase Boleto Turístico tourist ticket, cannot buy separate ticket. 'Partial Ticket (Circuit 3)' is available at the entrance, but highly recommended to purchase at official offices in Cusco in advance.",
    ...
    faq: { title: "Frequently Asked Questions", subtitle: "Learn More About Ollantaytambo", items: [
      ...
      { question: "Is there an entrance fee to see Ollantaytambo?", answer: "Yes. Ollantaytambo cannot be entered with a separate ticket at the gate. You must have the 'Cusco Tourist Ticket' (Boleto Turístico del Cusco). The ticket has several options:\n• Full Ticket (130 soles, valid 10 days): Includes all sites\n• Circuit 3 (70 soles, valid 2 days): Includes Ollantaytambo, Pisac, Chinchero, Moray\nAlthough the 'Partial Ticket (Circuit 3)' is usually available at the entrance, it is highly recommended to buy it in advance at official offices in Cusco to avoid scams and save queuing time. Ticket prices may change, subject to official announcement." },
  ...
  es: {
    ...
    visiting: {
      ...
      price: { title: "Entrada", content: "No se puede comprar entrada separada\nRequiere 'Boleto Turístico del Cusco'\nCircuito 3 disponible en la entrada", note: "⚠️ Nota Importante: Ollantaytambo no se puede ingresar con una entrada separada en la puerta, debe comprar el Boleto Turístico.", ticketTip: "🎫 Consejo de Entrada: No se venden entradas individuales. Debe comprar el Boleto Turístico del Cusco. Aunque el 'Boleto Parcial (Circuito 3)' que incluye este sitio suele estar disponible en la entrada, se recomienda encarecidamente comprarlo por adelantado en las oficinas oficiales de Cusco para ahorrar tiempo de fila." },
    ...
    transportation: {
      title: "Cómo Llegar y Tren a Machu Picchu",
      ...
      train: { title: "Importante: Tren a Machu Picchu", content: "Ollantaytambo es el centro de trenes más importante a Machu Picchu. Los trenes desde aquí son los más frecuentes, más baratos y más cortos (aproximadamente 1.5 horas) que desde Cusco.", steps: ["Alta demanda: Debe reservar boletos de tren con anticipación en los sitios web oficiales", "La estación de tren está a unos 15 minutos a pie de la entrada a las ruinas", "Elija entre PeruRail o Inca Rail", "Consejo: Visite las ruinas en el día, luego tome un tren vespertino a Aguas Calientes"] }
    },
    tips: { title: "Consejos", items: [
      ...
      "🎫 Consejo de Entrada: Debe comprar Boleto Turístico, no se puede comprar entrada separada. El 'Boleto Parcial (Circuito 3)' está disponible en la entrada, pero se recomienda comprar en oficinas oficiales de Cusco por adelantado.",
    ...
    faq: { title: "Preguntas Frecuentes", subtitle: "Aprenda Más Sobre Ollantaytambo", items: [
      ...
      { question: "¿Hay entrada?", answer: "Sí, requiere Boleto Turístico. Solo Circuito 3 (70 soles, válido 2 días): Incluye Ollantaytambo, Pisac, Chinchero, Moray. Aunque el 'Boleto Parcial (Circuito 3)' suele estar disponible en la entrada, se recomienda encarecidamente comprarlo por adelantado en las oficinas oficiales de Cusco." }
    ]},
  ...
  qu: {
    ...
    about: {
      ...
      highlights: { title: "Rikuy", items: ["Megalithic Wall: 6 stones", "Living City: Runakuna kachkan", "Viracocha uya: Pinkuylluna urqupi", "Intihuatana: Solar", "Terraces: Inca", "Gateway: Machu Picchu"] },
    ...
    transportation: {
      ...
      train: { title: "Machu Picchu Tren", content: "Ollantaytambo-manta Machu Picchu-man tren kachkan.", steps: ["Boleto rantiy", "Tren estación 15 min", "PeruRail, Inca Rail"] }
    },

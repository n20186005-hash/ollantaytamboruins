...
const GOOGLE_REVIEWS = [
  { name: "María G.", avatar: "MG", rating: 5, date: "2024-11-20", text: "Increíble ver Ollantaytambo en persona. La precisión del corte de la piedra es asombrosa. Un must-see en el Valle Sagrado." },
  { name: "John S.", avatar: "JS", rating: 5, date: "2024-10-15", text: "Ollantaytambo is a masterpiece of Inca stonework. The massive stones weighing over 50 tons are amazing! A must-visit before Machu Picchu." },
  { name: "Carlos R.", avatar: "CR", rating: 5, date: "2024-09-10", text: "Una obra maestra de la arquitectura inca. Ollantaytambo es impresionante con sus piedras megalíticas y terrazas." },
  { name: "李小美", avatar: "李", rating: 5, date: "2024-08-25", text: "奥扬泰坦博真的很震撼！巨大的石块重达50多吨，印加人的建筑技术令人惊叹。圣谷必看的景点！" },
  { name: "Ana P.", avatar: "AP", rating: 5, date: "2024-07-18", text: "Hermoso ejemplo de la arquitectura inca. Ollantaytambo es único en el mundo. Muy recomendado visitar." },
  { name: "Michael T.", avatar: "MT", rating: 5, date: "2024-06-05", text: "Fantastic example of Inca masonry. Ollantaytambo is world-famous for good reason. The megalithic stones are incredible! Perfect gateway to Machu Picchu." },
];
    ...
    <section className="hero">
      ...
      <a href={MAPS_URL} target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none", color: "inherit" }}>
        <div className="hero-meta">
          ...
          <div className="hero-reviews">26,178 {t.rating.reviews} · {t.rating.source}</div>
        </div>
      </a>
    </section>
  );
...
function Architecture() {
  const { t } = useLang();
  if (!t.architecture) return null;
  return (
    <section id="architecture" className="section" style={{ background: "linear-gradient(180deg, #fefefe 0%, #f4f1eb 100%)" }}>
      <ScrollReveal>
        <p className="section-label">02</p>
        <h2 className="section-title">{t.nav.architecture}</h2>
        <div className="section-divider" />
      </ScrollReveal>
      <ScrollReveal>
        <div style={{ marginTop: "2rem", padding: "2rem", background: "#fff", borderRadius: "8px", border: "1px solid rgba(0,0,0,0.05)", boxShadow: "0 4px 20px rgba(0,0,0,0.03)" }}>
          ...
          <div style={{ fontSize: "1rem", lineHeight: "1.8", color: "var(--color-earth)", whiteSpace: "pre-line" }} dangerouslySetInnerHTML={{ __html: t.architecture.content.replace(/\*\*(.*?)\*\*/g, '<strong>$1</strong>') }} />
        </div>
      </ScrollReveal>
    </section>
  );
...
function OllantaytamboHistory() {
  const { t } = useLang();
  if (!t.ollantaytambo) return null;
  return (
    <section id="history" className="section" style={{ background: "linear-gradient(180deg, #f4f1eb 0%, #fefefe 100%)" }}>
      <ScrollReveal>
        <p className="section-label">04</p>
        <h2 className="section-title">{t.nav.history || t.ollantaytambo.title}</h2>
        <div className="section-divider" />
      </ScrollReveal>
      <ScrollReveal>
        <div style={{ marginTop: "2rem", padding: "2rem", background: "#fff", borderRadius: "8px", border: "1px solid rgba(0,0,0,0.05)", boxShadow: "0 4px 20px rgba(0,0,0,0.03)" }}>
          <h3 style={{ fontFamily: "var(--font-display)", fontSize: "1.3rem", fontWeight: 600, color: "var(--color-deep)", marginBottom: "1rem" }}>
            {t.ollantaytambo.subtitle}
          </h3>
          <div style={{ fontSize: "1rem", lineHeight: "1.8", color: "var(--color-earth)", whiteSpace: "pre-line" }} dangerouslySetInnerHTML={{ __html: t.ollantaytambo.content.replace(/\*\*(.*?)\*\*/g, '<strong>$1</strong>') }} />
        </div>
      </ScrollReveal>
    </section>
  );
      ...
      <div className="section">
        ...
        <ScrollReveal>
          <div style={{ 
            ...
            borderRadius: "12px", 
            border: "2px solid #fdcb6", 
            boxShadow: "0 4px 20px rgba(253, 203, 102, 0.3)" 
          }}>
            <h3 style={{ 
            ...
            }} dangerouslySetInnerHTML={{ __html: (t.visiting.price as any).ticketTip?.replace(/\*\*(.*?)\*\*/g, '<strong>$1</strong>') || '' }} />
          </div>
        </ScrollReveal>
      ...
      <ScrollReveal>
        <div className="location-section">
          <div className="location-map-container">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15537.662012345678!2d-72.2681412!3d-13.2589799!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x916dd7e6e6e6e6e6%3A0x6e6e6e6e6e6e6e6e!2sOllantaytambo!5e0!3m2!1sen!2sus!4v1700000000000!5m2!1sen!2sus"
              width="800"
              height="600"
              style={{ border: 0 }}
              allowFullScreen
              ...
              title="Ollantaytambo Location Map"
            />
          </div>
